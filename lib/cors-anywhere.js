          ...
          return proxyReqOn.call(this, 'response', function(proxyRes) {
            if (onProxyResponse(proxy, proxyReq, proxyRes, req, res)) {
              try {
                ...
                // https://github.com/Rob--W-anywhere/issues/95
...
function getHandler(options, proxy) {
  ...
  return function(req, res) {
    ...
    var location = parseURL(req.url.slice(2));
    ...
    var proxyBaseUrl = (isRequestedOverHttps ? 'https://' : 'http://') + req.headers.host + "/cors";
...
exports.createServer = function createServer(options, curServer) {
  options = options || {};
...
curServer.get("/cors/:url", requestHandler);
